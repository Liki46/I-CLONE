...
var con = mysql.createConnection
    ({
        host : "localhost",
          user : "root",
            password : "Password@12",//password given for root user in MySql database
            insecureAuth : true,
       database : "iclone" 
});
        ...
        let sampleFile = req.files.sampleFile;
          console.log(sampleFile);
            // Use the mv() method to place the file somewhere on your server
              sampleFile.mv(`/home/big_shot_blood/Desktop/ICLONE/public/${req.body.photo_name}.JPG`, 
                function(err) {
                  if (err)
                                ...
                                if (err) 
                                  console.log( err);
                                    console.log(results);
                                      ...
                                      var sql9 = `insert into Photo_Cre_date values((select photo_id from  photos where Photo_Name='${req.body.photo_name}.JPG') ,'2020-12-08 12:35:56')`;
                                      con.query(sql9,function (err, results,fields) {
                                           if (err) 
